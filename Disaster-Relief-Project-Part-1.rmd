...
lda_cv_viz + qda_cv_viz + logreg_cv_viz + plot_layout(ncol=2)
```
...
# Visualize ROC plots
lda_roc + qda_roc + log_roc + plot_layout(ncol=2)
```
...
lda_distribution + qda_distribution + log_reg_distribution + plot_layout(ncol=2)
