...
### Polynomial Support Sector Machine
...
poly_svm_model_tuned <- linear_svm_wf %>% 
...
lda_cv_viz + qda_cv_viz + logreg_cv_viz + knn_cv_viz + elastic_cv_viz + linear_svm_cv_viz + poly_svm_cv_viz + rf_cv_viz + plot_layout(ncol=2)
```
...
poly_svm_roc <- get_ROC_plot(poly_svm_final_fit, train_data, test_data, "Linear SVM Model")
rf_roc <- get_ROC_plot(rf_model_tuned, train_data, test_data, "Random Forest Model")

# Visualize ROC plots
lda_roc + qda_roc + log_roc + knn_roc + elastic_roc + linear_svm_roc + poly_svm_roc + rf_roc + plot_layout(ncol=2)
