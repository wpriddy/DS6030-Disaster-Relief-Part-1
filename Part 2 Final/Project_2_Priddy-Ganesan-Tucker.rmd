...
When analyzing the threshold performance, we found that there were many thresholds which performed equally well, so we chose the highest threshold so as to conform to our other models. At this threshold of 0.85, we found that the model had 1,695 false positives, and an ROC AUC score of 0.976.
