...
lda_cv_viz + qda_cv_viz + logreg_cv_viz + knn_cv_viz + elastic_cv_viz + linear_svm_cv_viz + poly_svm_cv_viz + plot_layout(ncol=2)
```
...
# Visualize ROC plots
lda_roc + qda_roc + log_roc + knn_roc + elastic_roc + linear_svm_roc + poly_svm_roc + plot_layout(ncol=2)
