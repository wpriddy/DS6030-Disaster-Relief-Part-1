...
```{r tuning-results, fig.cap="KNN and Penalized Log Reg Tuning Results", fig.height=10}

knn_tuning_viz <- autoplot(knn_tune_results)
elastic_tuning_viz <- autoplot(tune_results)

knn_tuning_viz + elastic_tuning_viz + plot_layout(nrow=2)
```
